...
class ArtworkContent:
    ...
    def preprocessing(self, features):
        ...
        #artwork_features = ['artist_id', 'artwork_medium', 'materials', 'artwork_year', 'artwork_price']
...
#         data.artwork_year = data.artwork_year.astype(int)
#         try:
...
#             pass
    ...
    def split_column(self, data, feature):
        """
        split column into two or more columns
        ex: if an artwork has two or more artists
    ...
    def sort_results(self, similarity_results):
        ...
        for i in tqdm(similarity_results.keys()):
            ...
            temp_df = final.sort_values(['score', "same_medium", "price_sort", "year_sort"], ascending = (False, False, True, True))
